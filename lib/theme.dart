...
final ThemeData snackDefaultTheme = ThemeData(
...
class AppColors extends Color {
  ...
  static const MaterialColor snackGray = MaterialColor(
    _grayPrimaryValue,
    <int, Color>{
      50: Color(0xFFFFEBEE),
